  ...
  <div class="resource-wrapper">
    <div class="resource">
      <div class="d-flex justify-content-start align-items-center">
        ...
        <!-- Nombre -->
        <div class="ms-3 text-uppercase name-text">
          <span>{{ resources.resources.life.name }}</span>
        </div>
        <!-- Valor -->
        <div class="ms-3">
          <span class="text-monospace">
            {{ $filters.formatNumber(resources.resources.life.val) }}
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="resource">
      <div class="d-flex justify-content-start align-items-center">
        ...
        <!-- Nombre -->
        <div
          class="ms-3 text-uppercase name-text"
              ...
              <span>
                {{
                  $filters.formatNumber(
                    resources.resources.secondaryResource.val,
                  )
                }}
              </span>
            </template>
